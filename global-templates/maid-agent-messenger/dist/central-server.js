...
executeCreateTask, executeGetTask, executeListTasks, executeUpdateTask, executeGetReport, } from "./services/index.js";
const app = express();
...
app.patch("/api/tasks/:id/star", async (req, res) => {
    try {
        const projectPath = getProjectPathFromRequest(req);
...
app.get("/dashboard/completed", async (req, res) => {
    try {
        const projectPath = req.query.project
