 ...
 */
export function extractAgentIdFromPath(filePath) {
 ...
 */
export async function findAgentImages(imagesDir, agentId) {
    try {
 ...
 */
export function generateAgentBackgroundSnippet(imageUrl) {
    const css = `
    .agent-background {
      position: fixed;
      bottom: 0;
