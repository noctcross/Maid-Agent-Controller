 ...
 */
export function getDashboardBodyTemplate(params) {
    const { projectPath, timestamp, stats, teamStatusHtml, masterWaitingCount, masterWaitingSectionHtml, filteredPendingCount, pendingHtml, workingCount, workingHtml, completedTotal, completedHtml, skillCandidatesCount, skillCandidatesHtml, improvementsCount, improvementsHtml, } = params;
    return `
<body>
  <div class="header">
    <div>
 ...
 */
export function getReportOverlayHtml() {
    return `
