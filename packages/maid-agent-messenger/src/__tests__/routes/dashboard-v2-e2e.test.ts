      ...
      phases: [
        {
          ...
          actions: [
            { id: "310-1", title: "要件定義", type: "action", mainStatus: "closed", v2Substatus: "completed" },
            { id: "310-2", title: "基本設計", type: "action", mainStatus: "closed", v2Substatus: "completed" },
          ],
        },
        {
          id: "310-P2",
          ...
          v2Substatus: "working",
          actions: [
            { id: "310-3", title: "バックエンド実装", type: "action", mainStatus: "open", v2Substatus: "working" },
            { id: "310-4", title: "フロントエンド実装", type: "action", mainStatus: "open", v2Substatus: "pending" },
          ],
        },
      ],
    },
