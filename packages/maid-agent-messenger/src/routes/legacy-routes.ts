...
// get_my_task (REST)
router.post("/tools/get_my_task", async (req: Request, res: Response) => {
  try {
...
// update_status (REST)
router.post("/tools/update_status", async (req: Request, res: Response) => {
  try {
    const projectPath = getProjectPathFromRequest(req);
...
// assign_task (REST)
router.post("/tools/assign_task", async (req: Request, res: Response) => {
  try {
    const projectPath = getProjectPathFromRequest(req);
...
router.post("/tools/get_team_status", async (req: Request, res: Response) => {
  try {
    const projectPath = getProjectPathFromRequest(req);
