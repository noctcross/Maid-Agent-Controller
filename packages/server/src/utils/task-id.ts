 ...
 */
export function normalizeTaskId(taskId: string, agentId?: string): string {
 ...
 */
export function normalizeParentId(id: string | null | undefined): string | null {
 ...
 */
export function isSameTaskId(id1: string | null | undefined, id2: string | null | undefined): boolean {
