...
2. .maid-agent/core/instructions/{role}.md で自分の役割を確認
3. .maid-agent/core/instructions/QUICK_REFERENCE.md で通信方法を確認
4. .maid-agent/core/.claude/rules/common/ と rules/{role}/ でルールを確認
5. .maid-agent/core/.claude/skills/ で利用可能なスキルを確認
